...
public:
	...
	void set(ofRectangle coordinateSystemBounds); // Set the bounds of the coordinate system
	...
	ofRectangle canvas; // The 2D plane of the coordinate system, i.e., what is being navigated
	...
	ofVec2f dragStartPos; // Starting position of the cursor for the current mouse dragging event(if applicable)
	ofVec2f offset; // The two-dimensional offset of the coordinate system's current frame of reference from the origin
};
...
/** EXACT SAME as above but using the custom Square objects instead of the openframeworks 'ofRectangle'
class CoordinateSystem2D
{
public:
	/// @section Constructors
